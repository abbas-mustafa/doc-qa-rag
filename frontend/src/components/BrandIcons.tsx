...
/**
 * Follows the same shape as abbas-portfolio's BrandIcons, but this one keeps its
 * official brand colours rather than `currentColor` — Google's sign-in branding
 * guidelines require the mark be shown in its own palette, and a monochrome
 * version reads as a knock-off.
 */
